...
import stylesCss from 'themes/fortunequotes/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_fortunequotes_componentCss']) {
    
    document['_vaadintheme_fortunequotes_componentCss'] = true;
  }
